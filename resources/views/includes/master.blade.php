...
<body>
<nav class="d-flex">
        <ul class="navbar navbar-dark bg-dark justify-content-center mb-0 w-100">
            ...
            <li><a href="/processes" class="navbar-brand p-5">Control center</a></li>
            <li>
              </li>
            </ul>
            <form action="/logout" method="post">@csrf<input type="submit" value="Logout" class="btn btn-dark w-100 h-100 rounded-0"></form>
    </nav>
    @yield('content')
